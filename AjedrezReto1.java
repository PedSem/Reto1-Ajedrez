...
public class AjedrezReto1 {
    ...
    public static String movimiento (int i, int letra, int numero) {
        /*
        | 1 2 3 |
        | 4 X 5 |
        | 7 8 9 |
    ...
    public static void main(String[] args) {
        ...
        if (letra != 1 && numero != 1 && letra != 8 && numero != 8) {
            ...
            movimientos += movimiento(1, letra, numero) + movimiento(2, letra, numero) + movimiento(3, letra, numero) + movimiento(4, letra, numero) + movimiento(6, letra, numero) + movimiento(7, letra, numero) + movimiento(8, letra, numero) + movimiento(9, letra, numero);

        } else if (letra == 1 && numero == 1){
            System.out.println("Esquina");

            // Posibles Movimientos del rey en la esquina inferior izquierda
            movimientos += movimiento(2, letra, numero) + movimiento(3, letra, numero) + movimiento(6, letra, numero);

        } else if (letra == 1 && numero == 8) {
            System.out.println("Esquina");

            // Posibles Movimientos del rey en la esquina superior izquierda
            movimientos += movimiento(6, letra, numero) + movimiento(8, letra, numero) + movimiento(9, letra, numero);

        } else if (letra == 8 && numero == 8) {
            System.out.println("Esquina");

            // Posibles Movimientos del rey en la esquina superior derecha
            movimientos += movimiento(4, letra, numero) + movimiento(7, letra, numero) + movimiento(8, letra, numero);

        } else if (letra == 8 && numero == 1) {
            System.out.println("Esquina");

            // Posibles Movimientos del rey en la esquina inferior derecha
            movimientos += movimiento(1, letra, numero) + movimiento(2, letra, numero) + movimiento(4, letra, numero);

        } else if (numero == 1) {
            System.out.println("Borde");

            // Posibles Movimientos del rey en el borde inferior (sin esquinas)
            movimientos += movimiento(1, letra, numero) + movimiento(2, letra, numero) + movimiento(3, letra, numero) + movimiento(4, letra, numero) + movimiento(6, letra, numero);
        } else if (letra == 1) {
            System.out.println("Borde");

            // Posibles Movimientos del rey en el borde izquierdo (sin esquinas)
            movimientos += movimiento(2, letra, numero) + movimiento(3, letra, numero) + movimiento(6, letra, numero) + movimiento(8, letra, numero) + movimiento(9, letra,numero);
        } else if (numero == 8) {
            System.out.println("Borde");

            // Posibles Movimientos del rey en el borde superior (sin esquinas)
            movimientos += movimiento(4, letra, numero) + movimiento(6, letra, numero) + movimiento(7, letra, numero) + movimiento(8, letra, numero) + movimiento(9, letra, numero);
        } else {
            System.out.println("Borde");

            // Posibles Movimientos del rey en el borde superior (sin esquinas)
            movimientos += movimiento(1, letra, numero) + movimiento(2, letra, numero) + movimiento(4, letra, numero) + movimiento(7, letra, numero) + movimiento(8, letra, numero);
        }
