...
public class Rey {
    ...
    public static String movimiento (int coordenada, int letra, int numero, String[][] tablero) {
        ...
        switch (coordenada) {
            case 1:
                ...
                return Tablero.columna(letra - 1) + "" + (numero + 1) + ", "; // Devuelve el String con texto de la posicion a la que puede moverse.
            case 2:
                tablero[letraTablero][numeroTablero + 1] = verde;
                tb.setTablero(tablero);
                return Tablero.columna(letra) + "" + (numero + 1) + ", ";
            case 3:
                tablero[letraTablero + 1][numeroTablero + 1] = verde;
                tb.setTablero(tablero);
                return Tablero.columna(letra + 1) + "" + (numero + 1) + ", ";
            case 4:
                tablero[letraTablero - 1][numeroTablero] = verde;
                tb.setTablero(tablero);
                return Tablero.columna(letra - 1) + "" + numero + ", ";
            case 6:
                tablero[letraTablero + 1][numeroTablero] = verde;
                tb.setTablero(tablero);
                return Tablero.columna(letra + 1) + "" + numero + ", ";
    ...
    public static String Rey(String[][] tablero, int letra, int numero) { //A este metodo lo he nombrado como Rey en lugar de MainRey ya que no tiene sentido, habria que buscar una designacion mejor para el metodo
        numero -= 1;
