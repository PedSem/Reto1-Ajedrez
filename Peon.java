...
public class Peon {
    public static void PiezaPeon(String letraString, int numero, String color) {
        ...
        String movimientos = (Peon(tablero, letra, numero, color)); // Guarda los posibles movimientos en un String para mostrarlos después
