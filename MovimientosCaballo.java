public class MovimientosCaballo {
    ...
    //Método que realiza un único movimiento del caballo
    public static String movimiento(int coordenada, int letra, int numero, String[][] tablero) {
        ...
        // Ajusta las coordenadas al índice de array (0 basado).
    ...
    //Método principal que calcula todos los movimientos posibles del caballo desde su posición actual
    public static String Caballo(String[][] tablero, int letra, int numero) {
        ...
        numero -= 1; // Ajuste al índice de array (0 basado).
        ...
        // Ajuste para coordinar con el sistema 1 basado.
        letra += 1;
        numero += 1;
